          ...
          <div className="mt-6">
            <div className="mt-6 flex flex-col gap-3">
              <button
                ...
                disabled={loading}
                className="w-full flex justify-center items-center py-2.5 px-4 rounded-xl shadow-sm bg-white border border-gray-300 text-sm font-bold text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-200 transition disabled:opacity-50"
              >
